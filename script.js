  ...
  itinerary: [
    ...
    },
    {
      ...
      timeline: [
        ...
        { time: { "zh-Hant": "13:00－16:00", en: "13:00-16:00" }, title: { "zh-Hant": "大洋路精華景點", en: "Great Ocean Road highlights" }, note: { "zh-Hant": "這段重點就是 Twelve Apostles、Loch Ard Gorge 和 London Arch。", en: "This is the main scenic stretch for the Twelve Apostles, Loch Ard Gorge, and London Arch." } },
        { time: { "zh-Hant": "13:30", en: "13:30" }, title: { "zh-Hant": "十二門徒岩", en: "Twelve Apostles" }, note: { "zh-Hant": "這個經典角度一定要留時間拍。", en: "Leave proper time for the classic Twelve Apostles viewpoint." } },
        { time: { "zh-Hant": "14:30", en: "14:30" }, title: { "zh-Hant": "Loch Ard Gorge", en: "Loch Ard Gorge" }, note: { "zh-Hant": "峽谷和海色都很漂亮。", en: "The cliff-and-cove view here is one of the prettiest on the route." } },
        { time: { "zh-Hant": "15:15", en: "15:15" }, title: { "zh-Hant": "London Arch", en: "London Arch" }, note: { "zh-Hant": "海蝕岩地形很有代表性。", en: "A well-known rock arch stop with a very distinct coastal shape." } },
    ...
    },
    {
      ...
      plan: { "zh-Hant": "企鵝歸巢＋動物行程", en: "Penguin Parade and wildlife day" },
      focus: { "zh-Hant": "這天比較放鬆，重點是企鵝、無尾熊和袋鼠。", en: "This is a softer day built around penguins, koalas, and kangaroos." },
      location: { "zh-Hant": "Queen Victoria Market / Phillip Island / Penguin Parade", en: "Queen Victoria Market / Phillip Island / Penguin Parade" },
      costAud: 260,
      ...
      timeline: [
        ...
        { time: { "zh-Hant": "下午", en: "Afternoon" }, title: { "zh-Hant": "動物行程 / 無尾熊區", en: "Wildlife stop or koala area" }, note: { "zh-Hant": "這段可以安排無尾熊、袋鼠，或小型野生動物園。", en: "This is the time for koalas, kangaroos, or a smaller wildlife stop." } },
        { time: { "zh-Hant": "傍晚", en: "Late afternoon" }, title: { "zh-Hant": "海邊散步等企鵝", en: "Coastal walk before the penguins" }, note: { "zh-Hant": "可以先看夕陽、吹海風。", en: "Use the light for a short coastal walk and sunset time." } },
